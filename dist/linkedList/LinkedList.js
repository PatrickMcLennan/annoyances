...
var LinkedList = /** @class */ (function () {
    ...
    LinkedList.prototype.deleteFromHead = function (value) {
        var deleted = false;
    ...
    LinkedList.prototype.delete = function (value) {
        ...
        var current = (_a = this.head) !== null && _a !== void 0 ? _a : this.EMPTY_NODE;
        while (current.next) {
    ...
    LinkedList.prototype.find = function (compare) {
        var empty = this.isEmpty();
        if (empty)
            return null;
        var node = this.head;
